...
class RelativeValues:
    ...
    def calculate_angles(self, real_corps_position_x, real_knee_position_x, real_ankle_position_x):
        ...
        print(" x_ankle = ", self.x_ankle, " y_knee = ", self.y_ankle, "angle_thigh = ", self.angle_cale)
        pass
